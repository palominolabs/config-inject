/**
 * A mixture of <a href="http://code.google.com/p/google-guice/">Guice</a> and
 * <a href="https://github.com/brianm/config-magic/">config-magic</a> to make configuration a little easier.
 *
 * <p>Use a {@code ConfigModuleBuilder} to define a stack of configuration sources, then include the resulting
